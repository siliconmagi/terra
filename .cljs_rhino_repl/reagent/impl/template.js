...
var G__44814 = o;
(G__44814[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__44816__i < G__44816__a.length) {G__44816__a[G__44816__i] = arguments[G__44816__i + 0]; ++G__44816__i;}
  args = new cljs.core.IndexedSeq(G__44816__a,0);
} 
...
var G__44823 = jsprops;
(G__44823["defaultValue"] = value);

(G__44823["onChange"] = ((function (G__44823,v,value,on_change){
return (function (p1__44820_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__44820_SHARP_);
});})(G__44823,v,value,on_change))
);

(G__44823["ref"] = ((function (G__44823,v,value,on_change){
return (function (p1__44821_SHARP_){
return (this$["cljsInputElement"] = p1__44821_SHARP_);
});})(G__44823,v,value,on_change))
);
...
var vec__44830 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__44830,(0),null);
var id = cljs.core.nth.call(null,vec__44830,(1),null);
var class$ = cljs.core.nth.call(null,vec__44830,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___44835 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___44835 == null)){
} else {
var key_44836 = temp__4661__auto___44835;
(jsprops["key"] = key_44836);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__44838 = (new reagent.impl.template.NativeWrapper());
(G__44838["name"] = c);
...
var len__26162__auto___44844 = arguments.length;
var i__26163__auto___44845 = (0);
while(true){
if((i__26163__auto___44845 < len__26162__auto___44844)){
args__26169__auto__.push((arguments[i__26163__auto___44845]));

var G__44846 = (i__26163__auto___44845 + (1));
i__26163__auto___44845 = G__44846;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq44842){
var G__44843 = cljs.core.first.call(null,seq44842);
var seq44842__$1 = cljs.core.next.call(null,seq44842);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__44843,seq44842__$1);
});
...
break;
default:
var G__44850 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__44850;
continue;
...
var n__26002__auto___44853 = a.length;
var i_44854 = (0);
while(true){
if((i_44854 < n__26002__auto___44853)){
(a[i_44854] = reagent.impl.template.as_element.call(null,(a[i_44854])));
...
var a = cljs.core.into_array.call(null,s);
var n__26002__auto___44856 = a.length;
var i_44857 = (0);
while(true){
if((i_44857 < n__26002__auto___44856)){
var val_44858 = (a[i_44857]);
if((cljs.core.vector_QMARK_.call(null,val_44858)) && ((reagent.impl.template.key_from_vec.call(null,val_44858) == null))){
(o["no-key"] = true);
} else {
}

(a[i_44857] = reagent.impl.template.as_element.call(null,val_44858));

var G__44859 = (i_44857 + (1));
i_44857 = G__44859;
continue;
} else {
}
...
var ctx = ({});
var vec__44863 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__44863,(0),null);
var derefed = cljs.core.nth.call(null,vec__44863,(1),null);
...
var G__44867 = (cljs.core.count.call(null,argv) - first_child);
switch (G__44867) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__44867){
