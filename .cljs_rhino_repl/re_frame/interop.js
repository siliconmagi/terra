...
return [cljs.core.str((function (){var pred__44636 = cljs.core.instance_QMARK_;
var expr__44637 = reactive_val;
if(cljs.core.truth_(pred__44636.call(null,reagent.ratom.RAtom,expr__44637))){
return "ra";
} else {
if(cljs.core.truth_(pred__44636.call(null,reagent.ratom.RCursor,expr__44637))){
return "rc";
} else {
if(cljs.core.truth_(pred__44636.call(null,reagent.ratom.Reaction,expr__44637))){
return "rx";
} else {
if(cljs.core.truth_(pred__44636.call(null,reagent.ratom.Track,expr__44637))){
return "tr";
} else {
return "other";
}
