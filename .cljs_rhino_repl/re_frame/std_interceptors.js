...
var vec__44209_44212 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_44213 = cljs.core.nth.call(null,vec__44209_44212,(0),null);
var only_after_44214 = cljs.core.nth.call(null,vec__44209_44212,(1),null);
var db_changed_QMARK__44215 = (cljs.core.some_QMARK_.call(null,only_before_44213)) || (cljs.core.some_QMARK_.call(null,only_after_44214));
if(db_changed_QMARK__44215){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_44213);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_44214);
...
var map__44222 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__44222__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__44222__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__44230 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__44230__$1;
var event = cljs.core.get.call(null,map__44230__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26162__auto___44233 = arguments.length;
var i__26163__auto___44234 = (0);
while(true){
if((i__26163__auto___44234 < len__26162__auto___44233)){
args__26169__auto__.push((arguments[i__26163__auto___44234]));

var G__44235 = (i__26163__auto___44234 + (1));
i__26163__auto___44234 = G__44235;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq44232){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq44232));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__25087__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__26169__auto__ = [];
var len__26162__auto___44241 = arguments.length;
var i__26163__auto___44242 = (0);
while(true){
if((i__26163__auto___44242 < len__26162__auto___44241)){
args__26169__auto__.push((arguments[i__26163__auto___44242]));

var G__44243 = (i__26163__auto___44242 + (1));
i__26163__auto___44242 = G__44243;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__44236_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__44237_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__44237_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq44238){
var G__44239 = cljs.core.first.call(null,seq44238);
var seq44238__$1 = cljs.core.next.call(null,seq44238);
var G__44240 = cljs.core.first.call(null,seq44238__$1);
var seq44238__$2 = cljs.core.next.call(null,seq44238__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__44239,G__44240,seq44238__$2);
});
